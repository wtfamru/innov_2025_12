...
@app.route('/form')
def form():
    return render_template('form.html', active_page='take-test')
...
@app.route('/nurse')
def nurse():
    return render_template('nurse.html', active_page='nurse')
...
def predict():
    ...
    return render_template('form.html', result=result, active_page='take-test')
